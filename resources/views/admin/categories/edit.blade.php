    ...
    <x-ui.container>
        <div class="row">
            <div class="col-md-12">
                ...
                <x-form action="{{ route('categories.update',['category'=>$category]) }}" method="PUT"
                        id="category-form">
                    <x-card>
                        <x-slot:header>
                        ...
                        <x-slot:body>
                            ...
                            <div class="row">
                                ...
                                <x-form.input-group name="name" label="Name" placeholder="Enter Name"
                                                    :value="$category->name"></x-form.input-group>
                            </div>
